...
class priceParserMarketplaceUpdateProcessor extends modObjectUpdateProcessor
{
    ...
    public function beforeSet()
    {
        ...
        if (empty($id)) {
            return $this->modx->lexicon('priceparser_marketplace_err_ns');
        }
...
return 'priceParserMarketplaceUpdateProcessor';
